...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to OTP verification page and pass the email address state
      navigate('/verify-reset-code', { state: { email: email.trim().toLowerCase() } });
    } catch (err) {
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="e.g. user@taskflow.com"
                disabled={loading}
              />
            </div>
            {emailError && (
